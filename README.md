<<<<<<< HEAD
# Резюме-портфолио fullstack-разработчика на Nuxt 4
...
- **projects** — информация о проектах (название, описание, технологии, ссылки)
...
MIT
=======
# Резюме Fullstack Junior Developer

## Данный проект создан на Nuxt4 для демонстрации основных навыков web разработки
>>>>>>> d5b947ee09390c5995ce51bacbe35639416ea4b5
